 ...
 */
public class overkillShootCommand extends Command {

    private final overkillShoot                   smartShoot;
    ...
    public overkillShootCommand(VisionSubsystem visionSubsystem,
                        overkillShoot smartShoot,
